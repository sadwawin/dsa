                                 ...
                                 UIGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.0, Color3.fromRGB(255, 110, 14)), ColorSequenceKeypoint.new(1.0, Color3.fromRGB(235,200, 0))}
                                       ...
                                       function ContainerContent:Colorpicker(text,preset,callback)
                                          ...
                                          ColorpickerBtn.BackgroundColor3 = Color3.fromRGB(255, 125, 4)
                                          ...
                                          Confirm.BackgroundColor3 = Color3.fromRGB(255, 125, 4)
                                       ...
                                       function ContainerContent:Line()
                                          ...
                                          Line.BackgroundColor3 = Color3.fromRGB(235,200, 0)
                                 ...
                                 UIGradient.Parent = Line
                                       ...
                                       function ContainerContent:Label(text)
                                          ...
                                          Label.BackgroundColor3 = Color3.fromRGB(235,200, 0)
                                 ...
                                 UIGradient.Parent = Label
                                       ...
                                       function ContainerContent:Textbox(text,desc,disapper,callback)
                                          ...
                                          TextboxFrame.BackgroundColor3 = Color3.fromRGB(255, 125, 4)
                                          TextboxFrame.Position = UDim2.new(2.22300889, 0, 0.202380955, 0)
                                       ...
                                       function ContainerContent:Bind(text,presetbind,callback)
                                          ...
                                          Bind.BackgroundColor3 = Color3.fromRGB(15, 15, 15)
                                          ...
                                          BindLabel.BackgroundColor3 = Color3.fromRGB(255, 125, 4)
                                 ...
                                 ----------------------------------
                                  ...
                                  if placeId == 2753915549 then
                                     OldWorld = true
                                     assss = "Blox Fruit [🌊 SEA 1]"
                                  elseif placeId == 4442272183 then
                                     NewWorld = true
                                     assss = "Blox Fruit [🌊 SEA 2]"
                                  elseif placeId == 7449423635 then
                                      ThridWorld = true
                                      assss = "Blox Fruit [🌊 SEA 3]"
                                  end
                                  ------------------------------------
                                  _G.ToggleUi = Enum.KeyCode.RightControl
                                  local win = Flux:Window("BOARD HUB",  "" ..assss , Color3.fromRGB(255, 125, 4), _G.ToggleUi)
                                  game:GetService("CoreGui").FluxLib.Name = "RobloxCoreUi"
                                  function Click()
                                      spawn(function()
                                     while wait() do
                                  ...
                                  if ThridWorld then
                                        if MyLevel == 1500 or MyLevel <= 1524 then 
                                              ...
                                              CFrameQuest = CFrame.new(-290, 44, 5580)
                                              CFrameMon = CFrame.new(-303, 71, 5720)
                                   ...
                                   elseif MyLevel == 1575 or MyLevel <= 1599 then
                                              ...
                                              CFrameMon = CFrame.new(6068, 79, -941)
                                  elseif MyLevel == 1600 or MyLevel <= 1624  then
                                              ...
                                              CFrameQuest = CFrame.new(5834, 51, -1103)
                                              CFrameMon = CFrame.new(6684, 378, 324)
                                  elseif MyLevel == 1625 or MyLevel <= 1649  then
                                              ...
                                              CFrameMon = CFrame.new(5788.92529, 825.262024, 1018.39337, -0.392948776, 4.81385642e-09, 0.919560373, 4.37846159e-09, 1, -3.36393957e-09, -0.919560373, 2.70440381e-09, -0.392948776)
                                  elseif MyLevel == 1650 or MyLevel <= 1699  then
                                              ...
                                              CFrameQuest = CFrame.new(5448.86133, 601.516174, 751.130676, 0, 0, 1, 0, 1, -0, -1, 0, 0)
                                              CFrameMon = CFrame.new(5404.76514, 608.576172, -186.028229, 0.867673635, -0.104842938, 0.485953063, 2.34430928e-08, 0.977508783, 0.2108946, -0.497134209, -0.182987675, 0.848158658)
                                        elseif MyLevel == 1700 or MyLevel <= 1724  then
                                              Ms = "Marine Commodore [Lv. 1700]"
                                              NaemQuest = "MarineTreeIsland"
                                              LevelQuest = 1
                                              NameMon = "Marine Commodore"
                                              CFrameQuest = CFrame.new(2178.57935, 28.7404747, -6740.38672, -0.165534034, -2.69058216e-08, -0.986204088, -4.69358419e-09, 1, -2.64943889e-08, 0.986204088, 2.43108755e-10, -0.165534034)
                                              CFrameMon = CFrame.new(2214.0603, 75.2482071, -7013.5083, -0.472130895, -6.41522391e-08, 0.881528437, -2.19340475e-08, 1, 6.10263911e-08, -0.881528437, 9.47695789e-09, -0.472130895)
                                        elseif MyLevel == 1725 or MyLevel <= 1774  then
                                              ...
                                              CFrameQuest = CFrame.new(2178.57935, 28.7404747, -6740.38672, -0.165534034, -2.69058216e-08, -0.986204088, -4.69358419e-09, 1, -2.64943889e-08, 0.986204088, 2.43108755e-10, -0.165534034)
                                              CFrameMon = CFrame.new(3678.03296, 160.559082, -6987.3916, 0.669802964, 2.96625942e-08, 0.742538869, 6.07438821e-11, 1, -4.00023232e-08, -0.742538869, 2.68387801e-08, 0.669802964)
                                  elseif MyLevel == 1775 or MyLevel <= 1799  then
                                              Ms = "Fishman Raider [Lv. 1775]"
                                              NaemQuest = "DeepForestIsland3"
                                              LevelQuest = 1
                                              NameMon = "Fishman Raider"
                                              CFrameQuest = CFrame.new(-10582, 332, -8759)
                                              CFrameMon = CFrame.new(-10446, 344, -8172)
                                      elseif MyLevel == 1800 or MyLevel <= 1824   then
                                              ...
                                              CFrameQuest = CFrame.new(-10582, 332, -8759)
                                              CFrameMon = CFrame.new(-10729, 386, -8762)
                                            elseif MyLevel == 1825 or MyLevel <= 1849   then
                                               ...
                                               CFrameMon = CFrame.new(-13234.04, 331.488495, -7625.40137, 0.707134247, -0, -0.707079291, 0, 1, -0, 0.707079291, 0, 0.707134247)
                                            elseif MyLevel == 1850 or MyLevel <= 1899  then
                                               ...
                                               CFrameQuest = CFrame.new(-13234.04, 331.488495, -7625.40137, 0.707134247, -0, -0.707079291, 0, 1, -0, 0.707079291, 0, 0.707134247)
                                               CFrameMon = CFrame.new(-13695.9258, 504.54541, -7139.84473, -0.788144588, 0.119315788, -0.603814423, -1.79616606e-08, 0.981030226, 0.193854943, 0.615490139, 0.152785733, -0.773193657)
                                            elseif MyLevel == 1900 or MyLevel <= 1924  then
                                               ...
                                               CFrameMon = CFrame.new(-12428.2344, 360.427063, -10400.5381, -0.634942353, 0.33064878, -0.698226035, 9.07730069e-08, 0.903782845, 0.427991271, 0.772559524, 0.271749705, -0.573850036)
                                            elseif MyLevel == 1925 or MyLevel <= 2000  then
                                               Ms = "Musketeer Pirate [Lv. 1925]"
                                               NaemQuest = "DeepForestIsland2"
                                               LevelQuest = 2
                                               NameMon = "Musketeer Pirate"
                                               CFrameQuest = CFrame.new(-12680.3818, 389.971039, -9902.01953, -0.0871315002, 0, 0.996196866, 0, 1, 0, -0.996196866, 0, -0.0871315002)
                                               CFrameMon = CFrame.new(-13333.0615, 473.201874, -9923.74707, 0.994270444, 0.0727437809, -0.0783236101, 5.72366829e-08, 0.732724488, 0.680525422, 0.106893621, -0.676626325, 0.728526294)
                                  ...
                                  CheckQuest()
                                  -------------------
                                  local AutoFram = win:Tab("Auto Farm","http://www.roblox.com/asset/?id=7040391851")
                                  -- Equip Weapon
                                  SelectToolWeapon = ""
                                                             ...
                                                             if game:GetService("Workspace").Enemies:FindFirstChild(Ms) then
                                                                if string.find(LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, NameMon) then
                                                                  ...
                                                                  game:GetService'VirtualUser':Button1Down(Vector2.new(1280, 672))
                                                                   game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame = v.HumanoidRootPart.CFrame *   CFrame.Angles(math.rad(-90),0,0) + Vector3.new(0,15,7)
                                                                   ...
                                                                   v.HumanoidRootPart.CanCollide = false
                                                                    if Magnet then 
                                                                      ...
                                                                      game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame = game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame *   CFrame.Angles(math.rad(-90),0,0) + Vector3.new(0,15,7)
                                  ...
                                  AutoFram:Toggle("Auto Legendary Sword"," ",false,function(Value)
                                  ...
                                  AutoFram:Toggle("Auto Electric Claw", "", false, function(vu)
                                     AutoElectricClaw = vu
                                 ...
                                 spawn(function()
                                   ...
                                   AutoFram:Toggle("Auto third World","...",false,function(vu)
                                      if SelectToolWeapon == "" and vu then
                                          Flux:Notification("Select Weapon!!!","Alright")
                                       else
                                          AutoNew2 = vu
                                      ...
                                      while wait(.1) do
                                          local MyLevel = game.Players.localPlayer.Data.Level.Value
                                          if MyLevel >= 1500 and NewWorld and AutoNew2 then
                                              game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game:GetService("Workspace").Map.IndraIsland.Model.TerrainGrass.CFrame
                                      while AutoNew2 do  wait()
                                          EquipWeapon(SelectToolWeapon)
                                          for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren())  do
                                              print(v)
                                          if game.Workspace.Enemies:FindFirstChild("rip_indra [Lv. 1500] [Boss]")  then
                                              ...
                                              game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args))
                                               until v.Humanoid.Health > 10000 or AutoNew2 == false
                                         end 
                                         end
                                         end
                                          end
                                   ...
                                   AutoFram:Toggle("Auto Factory","...",false,function(vu)
                                      if OldWorld or ThridWorld then
                                         Flux:Notification("Use in New World!!!","Alright")
                                      if SelectToolWeapon == "" and vu then
                                          Flux:Notification("Select Weapon!!!","Alright")
                                      else
                                      Factory = vu
                                  ...
                                  AutoFram:Toggle("Auto Saber","...",false,function(Value)
                                      if NewWorld or ThridWorld then
                                         Flux:Notification("Use in Old World!!!","Alright")
                                  ...
                                  wait(1)
                                                  ...
                                                  until _G.AutoSaber == false or off.CanCollide == false or _G.AFM == true
                                  ...
                                  local tool = game.Players.LocalPlayer.Backpack:FindFirstChild("Relic")
                                   ...
                                   if NewWorld or OldWorld then
                                         Flux:Notification("Use in ThridWorld!!!","Alright")
                                        else
                                   _G.HolyTorch = vu
                                 spawn(function()
                                     while wait() do
                                 ...
                                 AutoFram:Toggle("Auto Elite Hunter", "", _G.AutoElite, function(vu)
                                    if NewWorld or OldWorld then
                                         Flux:Notification("Use in ThridWorld!!!","Alright")
                                    else
                                    EliteHunter = vu
                                       ...
                                       if game:GetService("ReplicatedStorage"):FindFirstChild("Diablo [Lv. 1750]") or game:GetService("ReplicatedStorage"):FindFirstChild("Urban [Lv. 1750]") or game:GetService("ReplicatedStorage"):FindFirstChild("Deandre [Lv. 1750]") then
                                          ...
                                          if game.Players.LocalPlayer.PlayerGui.Main.Quest.Visible == true and string.find(game.Players.LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, "Diablo") or string.find(game.Players.LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, "Urban") or string.find(game.Players.LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, "Deandre") then
                                             for i,v in pairs(game:GetService("ReplicatedStorage"):GetChildren()) do
                                                if EliteHunter and v.Name == "Diablo [Lv. 1750]" or v.Name == "Urban [Lv. 1750]" or v.Name == "Deandre [Lv. 1750]" then
                                                   repeat wait(.1)
                                                      EquipWeapon(SelectToolWeapon)
                                                   ...
                                                   until Elite == false or EliteHunter == false or not v.Parent or v.Humanoid.Health <= 0 or game.Players.LocalPlayer.PlayerGui.Main.Quest.Visible == false
                                                   Elite = false
                                                end
                                             end
                                          else
                                 ...
                                 game:GetService("RunService").Heartbeat:Connect(function()
                                   ...
                                   AutoFram:Toggle("Auto Accessories","...",false,function(Value)
                                      if SelectTooAccessories == "" and Value then
                                         Flux:Notification("Select Accessories!!!","Alright")
                                      else
                                      ...
                                      while wait() do
                                         if AutoAccessories then
                                            ...
                                            if game.Players.LocalPlayer.Character:FindFirstChild("Humanoid") and game.Players.LocalPlayer.Character:FindFirstChild("Humanoid").Health > 0 then
                                              if CheckAccessories:FindFirstChild("CoolShades") or CheckAccessories:FindFirstChild("BlackSpikeyCape") or CheckAccessories:FindFirstChild("BlueSpikeyCape") or CheckAccessories:FindFirstChild("RedSpikeyCape") or CheckAccessories:FindFirstChild("Chopper") or CheckAccessories:FindFirstChild("MarineCape") or CheckAccessories:FindFirstChild("GhoulMask") or CheckAccessories:FindFirstChild("MarineCap") or CheckAccessories:FindFirstChild("PinkCape") or CheckAccessories:FindFirstChild("SaboTopHat") or CheckAccessories:FindFirstChild("SwanGlasses") or CheckAccessories:FindFirstChild("UsoapHat") or CheckAccessories:FindFirstChild("Corrida") or CheckAccessories:FindFirstChild("ZebraCap") or CheckAccessories:FindFirstChild("TomoeRing") or CheckAccessories:FindFirstChild("BlackCape") or CheckAccessories:FindFirstChild("SwordsmanHat") or CheckAccessories:FindFirstChild("SantaHat") or CheckAccessories:FindFirstChild("ElfHat") or CheckAccessories:FindFirstChild("DarkCoat") or CheckAccessories:FindFirstChild("MusketeerHat") or CheckAccessories:FindFirstChild("PrettyHelmet") or CheckAccessories:FindFirstChild("JawShield") or CheckAccessories:FindFirstChild("ValkyrieHelm") or CheckAccessories:FindFirstChild("PilotHelmet") or CheckAccessories:FindFirstChild("BandannaBlack") or CheckAccessories:FindFirstChild("BandannaRed") or CheckAccessories:FindFirstChild("BandannaGreen") or CheckAccessories:FindFirstChild("HunterCapeRed") or CheckAccessories:FindFirstChild("HunterCapeGreen") or CheckAccessories:FindFirstChild("HunterCapeBlack") or CheckAccessories:FindFirstChild("Lei") then
                                               else
                                   ...
                                   elseif SelectBoss == "Stone [Lv. 1550] [Boss]" then
                                         ...
                                         LevelQuestBoss = 3
                                         CFrameQuestBoss = CFrame.new(-290, 44, 5580)
                                         CFrameBoss = CFrame.new(-1006, 102, 7052)
                                   elseif SelectBoss == "Island Empress [Lv. 1675] [Boss]" then
                                         MsBoss = "Island Empress [Lv. 1675] [Boss]"
                                         NaemQuestBoss = "AmazonQuest2"
                                         LevelQuestBoss = 3
                                         CFrameQuestBoss = CFrame.new(5448, 602, 753)
                                         CFrameBoss = CFrame.new(5503, 602, 187)
                                   elseif SelectBoss == "Kilo Admiral [Lv. 1750] [Boss]" then
                                         MsBoss = "Kilo Admiral [Lv. 1750] [Boss]"
                                         NaemQuestBoss = "MarineTreeIsland"
                                         LevelQuestBoss = 3
                                         CFrameQuestBoss = CFrame.new(2178, 29, -6741)
                                         CFrameBoss = CFrame.new(3031, 457, -7067)
                                   elseif SelectBoss == "Beautiful Pirate [Lv. 1950] [Boss]" then
                                         MsBoss = "Beautiful Pirate [Lv. 1950] [Boss]"
                                         NaemQuestBoss = "DeepForestIsland2"
                                         LevelQuestBoss = 3
                                         CFrameQuestBoss = CFrame.new(-12682, 391, -9902)
                                         CFrameBoss = CFrame.new(5309, 23, -108)
                                      end
                                   end
                                   ...
                                   local SelectWeaponKillBoss = AutoFram:Dropdown("Select Weapon",Wapon,function(Value)
                                  ...
                                  AutoFram:Line()
                                  AutoFram:Label("Auto SwanGlasses")
                                  AutoFram:Toggle("Auto SwanGlasses"," ",false,function(vu)
                                     if OldWorld or ThridWorld then
                                         Flux:Notification("Use in New World!!!","Alright")
                                        else
                                      _G.SwanGlasses = vu
                                  ...
                                  spawn(function()
                                      ...
                                      game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = BOARD
                                  ...
                                  local swan = AutoFram:Dropdown("Select Weapon",Wapon,function(Value)
                                      swanwapon = Value
                                  end)
                                  AutoFram:Button("Refresh Weapon","", function()
                                      swan:Clear()
                                  ...
                                  AutoFram:Line()
                                  AutoFram:Label("Auto Pole", true)
                                  function pole()
                                        KEN = CFrame.new(-7911.14453, 5613.89795, -2272.67822, -0.585544586, -6.38371889e-09, 0.810640216, -2.4883267e-08, 1, -1.00988613e-08, -0.810640216, -2.60847095e-08, -0.585544586)
                                  end
                                  function hitbox()
                                           for i,v in pairs (game:GetService("Workspace").Enemies:GetChildren()) do
                                           if v.Name == "Thunder God [Lv. 575] [Boss]" then
                                              ...
                                              pole()
                                              game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = KEN
                                              end
                                           end
                                  end
                                  function atc()
                                  ...
                                  AutoFram:Toggle("Auto Pole"," ",false,function(vu)
                                        if NewWorld or ThridWorld then
                                         Flux:Notification("Use in Old World!!!","Alright")
                                        else
                                        _G.Pole = vu
                                  ...
                                  local pole = AutoFram:Dropdown("Select Weapon",Wapon,function(Value)
                                      polewapon = Value
                                  end)
                                  AutoFram:Button("Refresh Weapon","", function()
                                      pole:Clear()
                                  ...
                                  AutoFram:Line()
                                   ...
                                   AutoFram:Button("Check Ectoplasm","...",function()
                                      Flux:Notification("You have "..game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Ectoplasm","Check").." Ectoplasm","Alright")
                                   end)
                                   ...
                                   Persen = 15
                                   AutoFram:Slider("Health %","...",0,100,1,Persen,function(v)
                                      Persen = v
                                   end)
                                  ...
                                  AutoFram:Line()
                                   ...
                                   AutoFram:Toggle("Auto Bartilo","...",false,function(v)
                                      Bool = v
                                      ...
                                      while Observation do wait()
                                         ...
                                         elseif ThridWorld then
                                            if game.Workspace.Enemies:FindFirstChild("Musketeer Pirate [Lv. 1925]") then
                                               if game.Players.LocalPlayer.PlayerGui.ScreenGui:FindFirstChild("ImageLabel") then
                                                  repeat wait()
                                                  game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game.Workspace.Enemies:FindFirstChild("Musketeer Pirate [Lv. 1925]").HumanoidRootPart.CFrame * CFrame.new(0,3,0)
                                                  until Observation == false or not game.Players.LocalPlayer.PlayerGui.ScreenGui:FindFirstChild("ImageLabel")
                                               else
                                                  repeat wait()
                                               ...
                                               game.Players.localPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-13625.8, 443.894, -9805.42)
                                            end
                                         end
                                      end
                                   end)
                                   ...
                                   AutoFram:Button("Check Observation Haki level","...",function()
                                      Flux:Notification("Haki Level : "..game.Players.LocalPlayer.VisionRadius.Value,"Alright")
                                   end)
                                   AutoFram:Line()
                                   -- Magnet
                                   spawn(function()
                                      while  game:GetService("RunService").Stepped:wait(100) do
                                      game:GetService("RunService").Stepped:wait(100)
                                            ...
                                            for i, v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                                               ...
                                               if v.Name == Ms and v:FindFirstChild("Humanoid") and v.Humanoid.Health > 0 then
                                                  if v.Name == "Factory Staff [Lv. 800]" and (v.HumanoidRootPart.Position-game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).magnitude <= 200 then
                                                     ...
                                                     v.HumanoidRootPart.CFrame = PosMon
                                                  elseif v.Name == Ms and (v.HumanoidRootPart.Position-game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).magnitude <= 500 then
                                                     wait()
                                                     v.HumanoidRootPart.CanCollide = false
                                                     if setsimulationradius then 
                                                         sethiddenproperty(game.Players.LocalPlayer, "SimulationRadius", math.huge)
                                   ...
                                   local Stats = win:Tab("Auto Stats", "http://www.roblox.com/asset/?id=3340612851")
                                  ...
                                  melee = false
                                   ...
                                   PointStats = 1
                                   Stats:Line()
                                   Stats:Slider("Point","...",1,10,1,function(a)
                                      PointStats = a
                                   end)
                                   Stats:Line()
                                   spawn(function()
                                   ...
                                   local Meleel = Stats:Label("")
                                  local Defensel = Stats:Label("")
                                  local swordl = Stats:Label("")
                                  local gunl = Stats:Label("")
                                  local demonfruitl = Stats:Label("")
                                  
                                   Meleel:Refresh("Melee Points : "..game.Players.localPlayer.Data.Stats.Melee.Level.Value)
                                   Defensel:Refresh("Defense Points : "..game.Players.localPlayer.Data.Stats.Defense.Level.Value)
                                   swordl:Refresh("Sword Points : "..game.Players.localPlayer.Data.Stats.Sword.Level.Value)
                                   gunl:Refresh("Gun Points : "..game:GetService("Players").localPlayer.Data.Stats.Gun.Level.Value)
                                   demonfruitl:Refresh("Df Points : "..game.Players.localPlayer.Data.Stats["Demon Fruit"].Level.Value)
                                   spawn(function()
                                    while wait(1) do 
                                       Meleel:Refresh("Melee Points : "..game.Players.localPlayer.Data.Stats.Melee.Level.Value)
                                   Defensel:Refresh("Defense Points : "..game.Players.localPlayer.Data.Stats.Defense.Level.Value)
                                   swordl:Refresh("Sword Points : "..game.Players.localPlayer.Data.Stats.Sword.Level.Value)
                                   gunl:Refresh("Gun Points : "..game:GetService("Players").localPlayer.Data.Stats.Gun.Level.Value)
                                   demonfruitl:Refresh("DevilFruit Points : "..game.Players.localPlayer.Data.Stats["Demon Fruit"].Level.Value)
                                 end
                                 end)
                                   Stats:Line()
                                   local Teleport = win:Tab("Teleport", "http://www.roblox.com/asset/?id=7044226690")
                                   Teleport:Label("Misc Teleport")
                                   ...
                                   Teleport:Toggle("Auto Chest","", false, function(vu)
                                 _G.FarmChest = vu
                                 end)
                                 spawn(function()
                                 while wait(3) do
                                 ...
                                 game.Players.LocalPlayer.Character.Humanoid:ChangeState(11)
                                   ...
                                   if OldWorld then
                                      ...
                                      Teleport:Button("Teleport To ThridWorld","...",function()
                                          local args = {
                                              [1] = "TravelZou"
                                          }  
                                          game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args))
                                  ...
                                  if placeId == 7449423635 then
                                      Teleport:Button("Port Town","...",function()
                                          game.Players.localPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-299, 44, 5443)
                                      end)
                                  Teleport:Button("Hydra Island","...",function()
                                          game.Players.localPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(5189, 590, 1296)
                                      end)
                                  Teleport:Button("Gteat Tree","...",function()
                                          game.Players.localPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(2248, 7, -6305)
                                      end)
                                  Teleport:Button("Floating Turtle","...",function()
                                          game.Players.localPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-10008, 332, -8248)
                                      end)
                                  Teleport:Button("PineApple Village","...",function()
                                          game.Players.localPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-11209, 332, -10385)
                                      end)
                                  Teleport:Button("Castle Inland","...",function()
                                          game.Players.localPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-5638, 314, -2826)
                                      end)
                                  Teleport:Button("Raids Lab","...",function()
                                          game.Players.localPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-5060, 315, -2955)
                                      end)
                                  Teleport:Button("Mansion","...",function()
                                          game.Players.localPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-12549.1, 337.194, -7552.82)
                                      end)
                                  end
                                  
                                   Teleport:Line()
                                   local Raids = win:Tab("Esp Raids", "http://www.roblox.com/asset/?id=7251993295")
                                   ...
                                   Raids:Toggle("Auto Awakener","...",false,function(value)
                                      if NewWorld or ThridWorld then
                                         Awakener = value
                                      elseif OldWorld then
                                         Flux:Notification("Now fix!!!","Alright")
                                      end
                                   end)
                                  ...
                                  Raids:Button("Dungeon","...",function()
                                      ...
                                      elseif ThridWorld then
                                         game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-5060, 314.541321, -2955, 1, 3.89117218e-08, 2.75413481e-13, -3.89117218e-08, 1, 2.34832562e-08, -2.74499715e-13, -2.34832562e-08, 1)
                                      end
                                   end)
                                   Raids:Button("Awakening Room","...",function()
                                      ...
                                      elseif ThridWorld then
                                         game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new (-11560, 49, -7580)
                                      elseif OldWorld or ThridWorld then
                                         Flux:Notification("Use In New World!!!","Alright")
                                      end
                                   end)
                                   spawn(function()
                                         ...
                                         if NextIsland then
                                            ...
                                            if game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 5") or game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 4") or game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 3") or game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 2") or game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 1") then
                                               if game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 5") then
                                                  game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 5").CFrame*CFrame.new(0,60,0)
                                               elseif game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 4") then
                                                  game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 4").CFrame*CFrame.new(0,60,0)
                                               elseif game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 3") then
                                                  game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 3").CFrame*CFrame.new(0,50,0)
                                               elseif game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 2") then
                                                  game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 2").CFrame*CFrame.new(0,50,0)
                                               elseif game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 1") then
                                                  game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 1").CFrame*CFrame.new(0,50,0)
                                               end
                                            else
                                   ...
                                   Raids:Line()
                                  Raids:Label("Buy Microchip")
                                  Raids:Button("Chip flame","", function()
                                      local A_1 = "RaidsNpc"
                                      local A_2 = "Select"
                                      local A_3 = "Flame"
                                  ...
                                  Raids:Button("Chip Ice","...", function()
                                      local A_1 = "RaidsNpc"
                                      local A_2 = "Select"
                                      local A_3 = "Ice"
                                      local Event = game:GetService("ReplicatedStorage").Remotes["CommF_"]
                                  ...
                                  Raids:Button("Chip Quake","...", function()
                                      local A_1 = "RaidsNpc"
                                      local A_2 = "Select"
                                      local A_3 = "Quake"
                                      local Event = game:GetService("ReplicatedStorage").Remotes["CommF_"]
                                  ...
                                  Raids:Button("Chip Light","", function()
                                      local A_1 = "RaidsNpc"
                                      local A_2 = "Select"
                                      local A_3 = "Light"
                                      local Event = game:GetService("ReplicatedStorage").Remotes["CommF_"]
                                  ...
                                  Raids:Button("Chip Dark","...", function()
                                      local A_1 = "RaidsNpc"
                                      local A_2 = "Select"
                                      local A_3 = "Dark"
                                      local Event = game:GetService("ReplicatedStorage").Remotes["CommF_"]
                                  ...
                                  Raids:Button("Chip Sting","...", function()
                                      local A_1 = "RaidsNpc"
                                      local A_2 = "Select"
                                      local A_3 = "String"
                                      local Event = game:GetService("ReplicatedStorage").Remotes["CommF_"]
                                  ...
                                  Raids:Button("Chip Rumble","...", function()
                                      local A_1 = "RaidsNpc"
                                      local A_2 = "Select"
                                      local A_3 = "Rumble"
                                      local Event = game:GetService("ReplicatedStorage").Remotes["CommF_"]
                                  ...
                                  Raids:Button("Chip Magma","...",function()
                                      local args = {
                                     [1] = "RaidsNpc",
                                     [2] = "Select",
                                     [3] = "Magma"
                                 ...
                                 game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args))
                                  ...
                                  Raids:Button("Chip Human: Buddha","...",function()
                                     local A_1 = "RaidsNpc"
                                     local A_2 = "Select"
                                     local A_3 = "Human: Buddha"
                                     local Event = game:GetService("ReplicatedStorage").Remotes["CommF_"]
                                     Event:InvokeServer(A_1, A_2, A_3)
                                  end)
                                  Raids:Line()
                                   local Players = win:Tab("Players", "http://www.roblox.com/asset/?id=7252023075")
                                   PlayerName = {}
                                  ...
                                  local Player = Players:Dropdown("Selected Player",PlayerName,function(plys) --true/false, replaces the current title "Dropdown" with the option that t
                                     ...
                                     SelectedPly:Refresh(""..SelectedKillPlayer)
                                  end)
                                  ...
                                  game:GetService("RunService").Heartbeat:Connect(
                                   ...
                                   Players:Toggle("Kill Player","...",false,function(bool)
                                      if SelectedKillPlayer == "" and bool then
                                          Flux:Notification("Select Player to Kill!!!","Alright")
                                         elseif SelectKillWeapon == "" and bool then
                                         Flux:Notification("Select Weapon","Alright")
                                          else
                                      KillPlayer = bool
                                 ...
                                 local WeaponaKill = Players:Dropdown("Select Weapon",Waponkill,function(Value)
                                 ...
                                 spawn(function()
                                     while wait(.1) do
                                         if SafePlayer then
                                             pcall(function()
                                                 local X = math.random(0,1000000)
                                                 local Z = math.random(0,1000000)
                                                 game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(X,1000,Y)
                                                 game:GetService("Players").LocalPlayer.Character.Humanoid:ChangeState(11)
                                             end)
                                         end
                                     end
                                 ...
                                 Players:Line()
                                   local Misc = win:Tab("Misc", "http://www.roblox.com/asset/?id=2127046514")
                                   local LocalPlayer = game:GetService'Players'.LocalPlayer
                                  ...
                                  Ping = Misc:Label("")
                                  Fps = Misc:Label("")
                                  Ping:Refresh("Ping : "..game:GetService("Stats").Network.ServerStatsItem["Data Ping"]:GetValueString())
                                  ...
                                  Misc:Button("Join Pirates Team","...",function()
                                   ...
                                   Misc:Button("Inventory Fruit","...",function()
                                       local args = {
                                 ...
                                 game.Players.localPlayer.PlayerGui.Main.FruitInventory.Visible = true
                                  ...
                                  Misc:Button("Remove Door","...",function()
                                     game:GetService("Workspace").Map.CircleIsland.Lab.Combo.Door:Destroy()
                                  end)
                                  ...
                                  Misc:Line() 
                                   local Fruit = win:Tab("Devil Fruit", "http://www.roblox.com/asset/?id=192012829")
                                   SelectDevil = ""
                                   Check = false
                                   Fruit:Label("Devil Fruit Function")
                                   Fruit:Dropdown(
                                      "Devil Fruit Sniper",
                                      {
                                         "Bomb-Bomb",
                                   ...
                                   Fruit:Toggle("Buy Devil Fruit Sinper","...",false,function(value)
                                      if SelectDevil == "" and value then
                                         Flux:Notification("Select Devil Fruit","Alright")
                                      elseif value then
                                         BuyFruitSinper = vu
                                      end	
                                   end)
                                   Fruit:Line()
                                    Fruit:Button("Keep Fruit To Inventory","...",function()
                                    local a =     {
                                       "Bomb-Bomb",
                                       "Spike-Spike",
                                       "Chop-Chop",
                                 ...
                                 game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args))
                                   ...
                                   Fruit:Toggle("Auto Keep Fruit To Inventory","...",false,function(value)
                                    _G.Save_DF = value
                                    local a =     {
                                       "Bomb-Bomb",
                                       "Spike-Spike",
                                 ...
                                 Fruit:Line()
                                   Fruit:Toggle("Bring Fruit","...",false,function(value)
                                      TeleportDF = value
                                      pcall(function()
                                   ...
                                   Fruit:Line()
                                   local BuyItem = win:Tab("Buy item", "http://www.roblox.com/asset/?id=7294901968")
                                   -- Auto Buy Enhancement
                                   BuyItem:Label("Buy Fragments")
                                   BuyItem:Toggle("Auto Buy Enhancement (Use 1500 Fragments)","...",false,function(Value)
                                      Enhancement = Value    
                                 ...
                                 game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args))
                                  ...
                                  BuyItem:Label("Race Buy")
                                   ...
                                   BuyItem:Line()
                                   local Setting = win:Tab("Setting", "http://www.roblox.com/asset/?id=7040347038")
                                   Setting:Label("Auto Farm Lock")
                                  _G.lvl = false
                                         _G.lvl1 = nil
                                        
                                         Setting:Toggle("Lock Level", "...", false, function(t)
                                             _G.lvl = t
                                         end)
                                        Setting:Slider("Select Level Lock","...",1,2000,1,function(value)
                                       _G.lvl1 = value
                                   end)
                                      ...
                                      if  _G.lvl1 <= game.Players.LocalPlayer.Data.Level.Value then
                                  ...
                                  Setting:Toggle("Ghost Mon", "", false, function(Value)
                                     Ghostmon = Value
                                 end)
                                 ...
                                 local Fastatt = require(game:GetService("Players").LocalPlayer.PlayerScripts.CombatFramework) 
                                             Fastatt.activeController.timeToNextAttack = 0
                                             game:GetService'VirtualUser':CaptureController()
                                             game:GetService'VirtualUser':Button1Down(Vector2.new(959, 959))
                                  end
                                  end)
                                 end)
                                   ...
                                   Setting:Line()
                                   Setting:Label("Skill Setting(Auto mastery Devil Fruit)")
                                   ...
                                   Setting:Line()
                                   Setting:Label("Fake Stats")
                                  Setting:Textbox("Level (Press Enter)", "...", true, function(t)
                                           game:GetService("Players").LocalPlayer.Data.Level.Value = tonumber(t)
                                  end) 
                                  Setting:Textbox("Beli (Press Enter)", "...", true, function(t)
                                           game:GetService("Players").LocalPlayer.Data.Beli.Value = tonumber(t)
                                  end)
                                  Setting:Textbox("Fragments (Press Enter)", "...", true, function(t)
                                           game:GetService("Players").LocalPlayer.Data.Fragments.Value = tonumber(t)
                                  end)
                                  Setting:Textbox("Bounty/Honor (Press Enter)", "...", true, function(t)
                                           game:GetService("Players").LocalPlayer.leaderstats["Bounty/Honor"].Value = tonumber(t)
                                  end)
                                  Setting:Textbox("Point (Press Enter)", "...", true, function(t)
                                           game:GetService("Players").LocalPlayer.Data.Points.Value = tonumber(t)
                                  end)
                                  Setting:Textbox("Melee (Press Enter)", "...", true, function(t)
                                           game:GetService("Players").LocalPlayer.Data.Stats["Melee"].Level.Value = tonumber(t)
                                  end)
                                  Setting:Textbox("Defense (Press Enter)", "...", true, function(t)
                                           game:GetService("Players").LocalPlayer.Data.Stats.Defense.Level.Value = tonumber(t)
                                  end)
                                  Setting:Textbox("Sword (Press Enter)", "...", true, function(t)
                                           game:GetService("Players").LocalPlayer.Data.Stats.Sword.Level.Value = tonumber(t)
                                  end)
                                  Setting:Textbox("Gun (Press Enter)", "...", true, function(t)
                                          game:GetService("Players").LocalPlayer.Data.Stats.Gun.Level.Value = tonumber(t)
                                  end)
                                  Setting:Textbox("Demon Fruit (Press Enter)", "...", true, function(t)
                                           game:GetService("Players").LocalPlayer.Data.Stats["Demon Fruit"].Level.Value = tonumber(t)
                                  end)
                                  Setting:Line()
                                  Setting:Label("Misc Setting")
                                   ...
                                   Setting:Button("Destroy GUI", "...", function()
                                       game:GetService("CoreGui")["RobloxCoreUi"]:Destroy()
                                   end)
                                   Setting:Button("Copylink Discord", "...", function()
                                      setclipboard("https://discord.gg/jXmemhNbST")
                                   end)
                                   Setting:Line()
